  ...
  return (
    <div>
      ...
      <div className='w-[90vw] h-[25vh] m-auto flex justify-around' >
        ...
        <div className='w-1/8 p-2'>
        <Link to="/product/vegetables"><img className='object-cover rounded-full size-36 m-auto transition-all ease-in-out hover:size-40 mt-6 border-2 border-black' src="images/products/vegetable.jpeg"></img> </Link>
        <Link to="/product/vegetables"><h1 className='text-center text-[20px] mt-1'>Vegetables</h1></Link>
        </div>
        ...
        <div className='w-1/8 p-2'>
        <Link to="/product/dry"><img className='transition-all ease-in-out hover:size-40 object-cover rounded-full size-36 m-auto mt-6 border-2 border-black' src="images/products/dryfruits.jpeg"></img> </Link>
        <Link to="/product/dry"><h1 className='text-center text-[20px] mt-1'>Dryfruits</h1></Link>
        </div>

        <div className='w-1/8 p-2'>
        <Link to="/product/spice"><img className='transition-all ease-in-out hover:size-40 object-cover rounded-full size-36 m-auto mt-6 border-2 border-black' src="images/products/spice.jpeg"></img> </Link>
        <Link to="/product/spice~"><h1 className='text-center text-[20px] mt-1'> Spices</h1></Link>
        </div>
