  ...
  if (isAuthenticated) {
    ...
    return (
      <div>
        ...
        <div className="relative top-[14vh] text-white px-10 text-end"><button className="h-[4.5vh] w-[8vw] text-[24px] bg-red-700 rounded-2xl">LogOut</button></div>
        </div>
        <div className="bg-gray-200 w-vw h-svh ">
          ...
          <div className=" w-[60vw] bg-white relative inset-[5%] rounded-xl flex flex-col">
            ...
            {items.map((k) => {
              ...
              return (
                <div className=" h-[15vh] mx-4 flex justify-around gap-2 border-b-2  ">
                  <div className="w-[10vw] h-[15vh]"><div>
                    <img
                      src={k.img}
                      alt="Item"
                  ...
                  <div className="w-[10vw] h-[15vh]"><div className=" mt-12 m-auto font-sans text-[25px]">{k.name}</div></div>
                  <div className="w-[8vw] h-[15vh]"><div className=" mt-[48px] fonts-sans font-light text-[23px]">{k.sp}</div></div>
                  <div className="w-[10vw]  h-[15vh]"><div className=" font-sans text-[25px] mt-[35px]"><div><button className="text-[30px] mr-4">-</button> {k.quantity} <button className="text-[30px] ml-4">+</button></div></div></div>
                  <div className="w-[10vw] h-[15vh]"><div className="font-sans mx-4 text-[23px] mt-[45px]"> Rs.{parseInt(k.sp)*parseInt(k.quantity)}</div></div>
                </div>
              );
            })}
        ...
        <div className="absolute h-[50vh] left-[70vw] top-[29vh]  rounded-xl text-white w-[26vw] bg-zinc-600 mt-10"> 
          ...
          <div className=" border-b-2 border-white text-center text-[30px] mt-2 mb-6 p-4">Order Summary</div>
          ...
          <div className="flex justify-between text-[18px] my-6">
            ...
            <div className="font-bold">Rs.{total+del}</div>
          </div>
          <div><button className="h-[5vh] w-[15vw] bg-red-500 relative left-[2.5vw] rounded-md text-[17px] transition-all ease-in-out hover:bg-red-600 hover:text-[19px]">Place Order</button></div>
          </div>
        </div>
      </div>
    );
